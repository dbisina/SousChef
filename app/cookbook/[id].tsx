        ...
        <View className="px-4 py-6">
          ...
          <View className="flex-row items-center mt-2">
            <View className="flex-row items-center">
              ...
              <Text className="text-neutral-600 ml-1">{cookbook.likes} likes</Text>
            </View>
            {cookbook.createdAt && (
              <>
          ...
          <View className="flex-row justify-around mt-6 py-4 bg-neutral-50 rounded-xl">
            <View className="items-center">
              ...
              <Text className="text-sm text-neutral-500">Recipes</Text>
            </View>
            ...
            <View className="items-center">
              ...
              <Text className="text-sm text-neutral-500">Likes</Text>
            </View>
          </View>
