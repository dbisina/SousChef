    ...
    <View className="flex-1 bg-white">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="relative">
          ...
          {/* Official badge */}
          {recipe.isOfficial && (
            <View className="absolute bottom-4 left-4 bg-primary-500 px-3 py-1 rounded-full flex-row items-center">
        ...
        <View className="px-4 py-6">
          ...
          <View className="flex-row items-center mt-2">
            <Text className="text-neutral-500">by {recipe.authorName}</Text>
          ...
          {/* Description */}
          <Text className="text-neutral-600 mt-4 leading-relaxed">
            {recipe.description}
          </Text>

          {/* Quick stats */}
          <View className="flex-row justify-around mt-6 py-4 bg-neutral-50 rounded-xl">
            <View className="items-center">
              <Text className="text-xl font-bold text-neutral-900">
                {recipe.prepTime}
              </Text>
              <Text className="text-sm text-neutral-500">Prep (min)</Text>
            </View>
            ...
            <View className="items-center">
              ...
              <Text className="text-sm text-neutral-500">Cook (min)</Text>
            </View>
            <View className="w-px bg-neutral-200" />
            <View className="items-center">
              <Text className="text-xl font-bold text-neutral-900">
          ...
          {user && (
            <Card className="mt-6 bg-primary-50 border border-primary-200">
              <View className="flex-row items-center justify-between mb-3">
                ...
                <View className="flex-row items-center">
                  <Text className="text-xs text-neutral-500 mr-2">Uses left:</Text>
              ...
              {substitutionResult ? (
                <View>
                  ...
                  {substitutionResult.substitutions.length > 0 && (
                    <View className="mt-2">
                      <Text className="font-medium text-neutral-700 mb-1">
                        Suggested Substitutions:
                      </Text>
                      {substitutionResult.substitutions.map((sub, idx) => (
                        <Text key={idx} className="text-neutral-600">
        ...
        <View className="flex-row space-x-3">
          <View className="flex-row items-center">
            <TouchableOpacity
              ...
              className="flex-row items-center px-4 py-3 bg-neutral-100 rounded-xl"
            >
